...
📬 bc833498@gmail.com &nbsp;·&nbsp; [LinkedIn](https://linkedin.com/in/bodapati-bharat-chandra-4b1b58290) &nbsp;·&nbsp; [GitHub](https://github.com/BharatChandra-sys)
...
**AUVBrain** — offline-first control system for an autonomous underwater vehicle. Deterministic `observe → decide → act` loop, 0.84ms p95 latency, LLM advisory layer with rules-based fallback for when the model times out underwater.
[→ Repository](https://github.com/BharatChandra-sys/AUVBrain)
...
[→Static website Live](https://vijethadigital.com) &nbsp;·&nbsp; [→ Full Live under development ](https://vijetha-digital-store.vercel.app/) &nbsp;·&nbsp; [→ Repository](https://github.com/BharatChandra-sys/vijetha-digital-backend)
...
[→ Live](https://deepthihospitals.vercel.app) &nbsp;·&nbsp; [→ Repository](https://github.com/BharatChandra-sys/hospital-management-platform)

**GARI** — GITAM Aerospace Rocketry Initiative. I lead CS.
[→ gari.live](https://gari.live)
